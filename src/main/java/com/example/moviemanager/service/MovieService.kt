...
class MovieService {
    private val apiKey = "YOUR_API_KEY" // Replace with your OMDb API key
    private val baseUrl = "https://www.omdbapi.com/"

    suspend fun fetchMovie(title: String): Movie? {
        Log.i(tag, "fetchMovie", msg = "Fetching movie with title: $title")
    ...
    suspend fun searchMoviesByTitle(title: String): List<Movie> {
        Log.i(tag, "searchMoviesByTitle", msg = "Searching movies with title: $title")
